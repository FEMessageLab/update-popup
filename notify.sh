...
git remote add github https://$GITHUB_TOKEN@github.com/FEMessage/version-checker.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/FEMessage/version-checker/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "version-checker更新", "text": "@所有人\n# [version-checker('$version')]('$html_url')\n'$body'"}}'
